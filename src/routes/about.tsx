...
import icanLogo from "@/assets/partner-ican.webp";
import citnLogo from "@/assets/partner-citn.webp";
import msiLogo  from "@/assets/partner-msi.png";
import frcLogo  from "@/assets/partner-frc.webp";
import ndpcLogo from "@/assets/partner-ndpc.webp";
      ...
      <section className="py-20 bg-[#EEF2FF]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="flex flex-wrap gap-6">
            {/* Image logos */}
            {[
              { src: icanLogo, alt: "ICAN", full: "Institute of Chartered Accountants of Nigeria" },
              { src: citnLogo, alt: "CITN", full: "Chartered Institute of Taxation of Nigeria" },
              { src: msiLogo,  alt: "MSI",  full: "Member, MSI Global Alliance" },
              { src: frcLogo,  alt: "FRC",  full: "Financial Reporting Council of Nigeria" },
              { src: ndpcLogo, alt: "NDPC", full: "Nigeria Data Protection Commission" },
            ].map((a) => (
              <div key={a.alt} className="bg-white border border-[#C8D4F5] p-6 rounded-lg flex flex-col items-center gap-3 min-w-[160px] hover:border-[#1B3FA0] hover:shadow-md transition-all">
                <img src={a.src} alt={a.alt} className="h-14 w-auto object-contain" />
                <div className="text-[10px] text-muted-foreground leading-relaxed text-center">{a.full}</div>
              </div>
            ))}
            {/* Text-only for those without images */}
